...
namespace LRT_MVC_Project.Models
{
    ...
    public class SubItemTypeField
    {
        ...
        [DisplayFormat(ConvertEmptyStringToNull = false)]
        public string Sub_Item_Type_Field_Optional_Full_Value { get; set; }
        [DisplayFormat(ConvertEmptyStringToNull = false)]
        ...
        public int InsertSubItemTypeField(SubItemTypeField objSubItemTypeField)
        {
            ...
            cmd.Parameters.AddWithValue("@UOM_Group_Id", objSubItemTypeField.UOM_Group_Id);
        ...
        public DataSet GetSubItemTypeFieldAccSubItemTypeId(SubItemTypeField objSubItemTypeField)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_m_subitemfield_acc_subitemtypeid", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Sub_Item_Type_Id", objSubItemTypeField.Sub_item_Type_Id);
        ...
        public DataSet GetSubItemTypeFieldOptionalValueAccId(SubItemTypeField objSubItemTypeField)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_m_subitemtypefield_optional_value_acc_id", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Sub_Item_Type_Field_Id", objSubItemTypeField.Sub_item_Type_Field_Id);
