...
namespace LRT_MVC_Project.Models
{
    public class Company
    {
        ...
        public int InsertCompanyMaster(Company objCompanyMaster)
        {
            ...
            cmd.Parameters.AddWithValue("@Langauge_Id", objCompanyMaster.Language_Id);
        ...
        public int InsertCompanyMasterForBulk(Company objCompanyMaster)
        {
            int i = 0;
            string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
            MySqlConnection con = new MySqlConnection(strcon);
            MySqlCommand cmd = new MySqlCommand("proc_Insert_t_companyforbulk", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@Company_Name", objCompanyMaster.Company_Name);
            cmd.Parameters.AddWithValue("@User_Id", objCompanyMaster.User_Id);
            cmd.Parameters.Add(new MySqlParameter("@error1", MySqlDbType.Int32));
    ...
    public class CompanyAddress
    {
        ...
        public DataSet GetCompanyAddressForListForPopup(CompanyAddress objCompanyAddress)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_t_company_address_for_list_for_popup", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Company_Address_Id", objCompanyAddress.Company_Add_Id);
                MySqlDataAdapter da = new MySqlDataAdapter(cmd);
                da.Fill(ds);
