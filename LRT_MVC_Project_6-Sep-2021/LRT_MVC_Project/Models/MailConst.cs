...
namespace LRT_MVC_Project.Models
{
    public class MailConst
    {
        ...
        public static string AdminEmail = "dipanshu@leaderrange.com";
       // public static string AdminEmail = "way2punita@gmail.com";
        public static string ToEmail = "kapil.duplex@gmail.com";
        public static string From = Username + "mail.leaderrange.com";
        #region//----------------------------mail for approval---------------------------------------------------
        public static void senderMail(string PageName,string Link)
        {
            ...
            Message += "<div style='margin-left: 10px;margin-right: 10px;padding-bottom: 10px;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4;padding-top: 40px'><div style='margin-left: 35px;margin-right: 10px;'><img src='cid:02'><span style='FONT-WEIGHT:bold;font-size:20px;color:white;'>Approval&nbsp;Notification</span> ";
           ...
           // Message.Body += "<br/><span style='color:white;padding-left:16px;'>Hello&nbsp;'" + companyname + "'</span>";
            Message += "<span style='color:WHITE;padding-left:16px;font-size: 13px;'>There is new change done by user for approval.</span>";
            Message += "<br/>";
            Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 14px;font-weight: 600; padding-right: 10px;'>USER NAME</span><span style='color:white;font-size:14px'>:</span><span style='color:white;padding-left:16px;font-size: 14px;font-weight: 600;'>" + Common.CommonSetting.name.ToUpper() + "</span> ";
            Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 14px;font-weight: 600; padding-right: 12px;'>CHANGE AT</span><span style='color:white;font-size:14px'>:</span><span style='color:white;padding-left:16px;font-size: 14px;font-weight: 600;'>" + PageName.ToUpper() + "</span> ";
            ...
            Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 13px;'>Admin must contact the user if any issue with the changes made.</span><img src='cid:03'> ";
            Message += "<br/><br/>";
            Message += "<br/><br/>";
            Message += "<br/><br/>";
            ...
            sendMail(ToEmail, PageName.ToString() +" approval notification.",Message);
        ...
        public static void sendMail(string ToEmail, string Subject, string EmailBody)
        {
            try
            {
                ...
                string logoImage1 = HttpContext.Current.Server.MapPath(@"~/Images/approval_notification.png");
                string logoImage2 = HttpContext.Current.Server.MapPath(@"~/Images/chatlogo1.png");
        ...
        public static void senderMailForRegistration(string Tovendor, string companyname, string contactperson)
        {
            ...
            Message += "<div style='background-color:#525252;width:650px;padding-bottom: 5px;padding-top: 5px;'>";
            Message += " <div style='background-color:#6D6D6D;margin-left: 10px;margin-right: 10px;border-top: 1px solid #A4A4A4;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4'><div style='position:relative;height:100px;text-align:center'><img src='cid:01' style='padding-top:10px'></div></div>";
            Message += "<div style='margin-left: 10px;margin-right: 10px;padding-bottom: 10px;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4;padding-top: 40px'><div style='margin-left: 35px;margin-right: 10px;'><img src='cid:02'><span style='FONT-WEIGHT:bold;font-size:20px;color:white;'>&nbsp;Vendor&nbsp;Notification</span> ";
            Message += "<br/> <hr style='border-top:1px solid #CCCCCC;margin-left: 10px;margin-right: 20px'/>";
            // Message.Body += "<br/><span style='color:white;padding-left:16px;'>Hello&nbsp;'" + companyname + "'</span>";
            Message += "<span style='color:WHITE;padding-left:16px;font-size: 14px;'>Hello&nbsp;'" + contactperson + "'</span>";
            Message += "<br/>";
            ...
            sendMailForRegistration(AdminEmail, subject, Message);
            //return Json(result, JsonRequestBehavior.AllowGet);
        }
        ...
        public static void senderMailForVenderStatus(string Tovendor, string companyname, string contactperson, string Statusmessage)
        {
           ...
           string subject = "LRT Vender Registration Notifiaction To " + companyname;
            ...
            Message += "<div style='background-color:#525252;width:650px;padding-bottom: 5px;padding-top: 5px;'>";
            Message += " <div style='background-color:#6D6D6D;margin-left: 10px;margin-right: 10px;border-top: 1px solid #A4A4A4;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4'><div style='position:relative;height:100px;text-align:center'><img src='cid:01' style='padding-top:10px'></div></div>";
            Message += "<div style='margin-left: 10px;margin-right: 10px;padding-bottom: 10px;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4;padding-top: 40px'><div style='margin-left: 35px;margin-right: 10px;'><img src='cid:02'><span style='FONT-WEIGHT:bold;font-size:20px;color:white;'>&nbsp;Registration&nbsp;Notification</span> ";
            Message += "<br/> <hr style='border-top:1px solid #CCCCCC;margin-left: 10px;margin-right: 20px'/>";
            // Message.Body += "<br/><span style='color:white;padding-left:16px;'>Hello&nbsp;'" + companyname + "'</span>";
            Message += "<span style='color:WHITE;padding-left:16px;font-size: 14px;'>Hello&nbsp;'" + contactperson + "'</span>";
            Message += "<br/>";
        ...
        #region//----------------------------mail for vendor Permission---------------------------------------------------
        public static void senderMailForVenderPermission(string Tovendor, string companyname, string contactperson, string Permissions,string UserId,string Password)
        {
            //System.Text.StringBuilder strBuilder = new System.Text.StringBuilder();
            string Message;
            // Message.Subject = "LRT Vender Invitation Notifiaction";#EE0000-red
            string subject = "LRT Vender Access Permission To " + companyname;

            Message = "<br/> ";
            Message += "<div style='background-color:#525252;width:650px;padding-bottom: 5px;padding-top: 5px;'>";
            Message += " <div style='background-color:#6D6D6D;margin-left: 10px;margin-right: 10px;border-top: 1px solid #A4A4A4;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4'><div style='position:relative;height:100px;text-align:center'><img src='cid:01' style='padding-top:10px'></div></div>";
            Message += "<div style='margin-left: 10px;margin-right: 10px;padding-bottom: 10px;border-left: 1px solid #A4A4A4;border-right: 1px solid #A4A4A4;padding-top: 40px'><div style='margin-left: 35px;margin-right: 10px;'><img src='cid:02'><span style='FONT-WEIGHT:bold;font-size:20px;color:white;'>Access&nbsp;Permission </span> ";
            Message += "<br/> <hr style='border-top:1px solid #CCCCCC;margin-left: 10px;margin-right: 20px'/>";
            // Message.Body += "<br/><span style='color:white;padding-left:16px;'>Hello&nbsp;'" + companyname + "'</span>";
            Message += "<span style='color:WHITE;padding-left:16px;font-size: 14px;'>Hello&nbsp;'" + contactperson + "'</span>";
           
            Message += "<br/><span style='color:white;padding-left:16px;'>Your have some permission for access portal.below has login details for access LRT portal </span>";
            Message += "<br/>";
            Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 14px;font-weight: 500;    padding-right: 39px;'>User Id</span><span style='color:white;font-size:14px'>:</span><span style='color:white;padding-left:16px;font-size: 14px;font-weight: 600;color:white'>" + UserId + "</span>";
             Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 14px;font-weight: 500;    padding-right: 20px;'>Password</span><span style='color:white;font-size:14px'>:</span><span style='color:white;padding-left:16px;font-size: 14px;font-weight: 600;color:white'>" + Password + "</a> </span> ";
             Message += "<br/>";
            Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 13px; padding-right: 10px;'>You have these permission for access portal -></span>";
             Message += "<br/><span style='color:WHITE;padding-left:16px;font-size: 13px;font-weight: 500; padding-right: 10px;'>" + Permissions + "</span>";
            Message += "<br/><br/><br/>";
            ...
            sendMailForVenderPermission(Tovendor, subject, Message);
            //return Json(result, JsonRequestBehavior.AllowGet);
        }

        public static void sendMailForVenderPermission(string ToEmail1, string Subject, string EmailBody)
        {
            try
            {
