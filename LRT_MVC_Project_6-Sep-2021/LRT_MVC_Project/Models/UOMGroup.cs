...
namespace LRT_MVC_Project.Models
{
    public class UOMGroup
    {
        ...
        public int InsertUOMGroupBulk(UOMGroup objuomgrp)
        {
            int i = 0;

            string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
            MySqlConnection con = new MySqlConnection(strcon);
            MySqlCommand cmd = new MySqlCommand("proc_Insert_m_umo_groupforbulk", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetUOMGroupNameAccUOMId(UOMGroup objUOMGroup)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_m_umo_group_name_Acc_uom", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@UOM_Id", objUOMGroup.UOM_Id);
        ...
        public DataSet GetUOMNameAccUOMGroupName(UOMGroup objUOMGroup)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_t_uom_acc_uom_group_name", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@UMO_Group_Id", objUOMGroup.UOM_Group_Id);
        ...
        public DataSet GetUOMListAccUOMGroupId(UOMGroup objUOMGroup)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_m_umo_name_Acc_uom_group", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@UOM_Group_Id", objUOMGroup.UOM_Group_Id);
        ...
        public DataSet GeAlttUOMListAccUOMGroupId(UOMGroup objUOMGroup)
        {
            DataSet ds = new DataSet();
            try
            {
                string strcon = ConfigurationManager.ConnectionStrings["myConStr"].ConnectionString;
                MySqlConnection con = new MySqlConnection(strcon);
                MySqlCommand cmd = new MySqlCommand("proc_get_m_umo_alt_name_Acc_uom_group", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@UOM_Group_Id", objUOMGroup.UOM_Group_Id);
    ...
    public class UOMGroupQty
    {
        ...
        public int GetUOMGroupQtyApproveStatus(UOMGroupQty objUOMGroupQty)
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UOM_Group_Mapping_Id", objUOMGroupQty.UOM_Group_Qty_Id);
            cmd.Parameters.AddWithValue("@User_Id", objUOMGroupQty.User_Id);
            cmd.Parameters.Add(new MySqlParameter("@error1", MySqlDbType.Int32));
            cmd.Parameters["@error1"].Direction = ParameterDirection.Output;
            try
